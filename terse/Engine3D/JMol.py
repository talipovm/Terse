...
class JMol(Top):
    ...
    def MultipleGeoms(self):
        ...
        jmolButton("anim direction +1 ;frame last_value",">>");
        jmolButton("anim mode once; frame 1; anim direction +1 ; anim on", "Play once");
        jmolButton("anim mode once; frame last_value ; anim direction -1 ; anim on", "Play back");
    ...
    def Vibration(self):
        s = 'jmolCheckbox("vibration on", "vibration off", "html_vibration_switch");'
        return web.tag(s,'SCRIPT')
